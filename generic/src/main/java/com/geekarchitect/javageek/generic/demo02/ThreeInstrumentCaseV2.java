 ...
 */
public class ThreeInstrumentCaseV2<T, U,V > extends InstrumentCase<T, U> {
     ...
     */
    public ThreeInstrumentCaseV2(T instrument1, U instrument2, V instrument3) {
        super(instrument1, instrument2);
        this.instrument3 = instrument3;
    }

    public ThreeInstrumentCaseV2() {
    }
